...
async function main() {
  ...
  const hackathonConfig = {
    ...
    roadmap: [
      ...
      { step: 5, task_id: 'FEATURE-4', round: 1, rubric: ['functionality', 'code_quality'] },
      { step: 6, task_id: 'FEATURE-5', round: 1, rubric: ['functionality', 'code_quality'] },
      { step: 7, task_id: 'FINAL-FEATURE', round: 1, rubric: ['functionality', 'code_quality'] },
